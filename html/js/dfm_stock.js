...
function portfolio_composition() {
    ...
    d3.json(portf_url).then(function (portfolio_data) {
        ...
        for (var i = 0; i < portf.length; i++) {
            ...
            if (portf[i].Volatility < 0.15) { 
                lowrisk_portf.push(portf[i])
            } 
            else if (portf[i].Volatility < 0.20) {
...
// Optimum low risk portfolio 
    ...
    // Optimum high risk portfolio 
        ...
        //     "BTC_weight": optortflowrisk[0].BTC_weight,
        ...
        let lowrisk_plot_values = [
            optortflowrisk[0].AAPL_weight,
            optortflowrisk[0].BTC_weight,
            optortflowrisk[0].DAL_weight,
            optortflowrisk[0].GOLD_weight,
            optortflowrisk[0].NFLX_weight,
            optortflowrisk[0].PFE_weight,
            optortflowrisk[0].SHOP_weight,
            optortflowrisk[0].TSLA_weight
        ]

        let modrisk_plot_values = [
            optortfmoderrisk[0].AAPL_weight,
            optortfmoderrisk[0].BTC_weight,
            optortfmoderrisk[0].DAL_weight,
            optortfmoderrisk[0].GOLD_weight,
            optortfmoderrisk[0].NFLX_weight,
            optortfmoderrisk[0].PFE_weight,
            optortfmoderrisk[0].SHOP_weight,
            optortfmoderrisk[0].TSLA_weight
        ]

        let highrisk_plot_values = [
            optortfhighrisk[0].AAPL_weight,
            optortfhighrisk[0].BTC_weight,
            optortfhighrisk[0].DAL_weight,
            optortfhighrisk[0].GOLD_weight,
            optortfhighrisk[0].NFLX_weight,
            optortfhighrisk[0].PFE_weight,
            optortfhighrisk[0].SHOP_weight,
            optortfhighrisk[0].TSLA_weight
        ]
